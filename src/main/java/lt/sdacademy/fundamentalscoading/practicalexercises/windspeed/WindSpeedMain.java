...
public class WindSpeedMain {
    ...
    public static void main(String[] args) {
        ...
        while (nuskaitymas) {
            ...
            System.out.println("Vejo greitis myliomis arba mazgais: "+ kilometersPerOurToKnots(windSpeed));
            ...
            //System.out.println("Vejo greitis Beaufoto skaleje: " + kilometersPerOurToBeufortScale(windSpeed));
            System.out.println("Vejo greitis Beaufoto skaleje: "+ kilometersPerOurToBeufortScale(windSpeed));
    ...
    private static int kilometersPerOurToKnots(double windSpeed) {
        return (int) (windSpeed * NAUTICAL_MILE);
    }

    private static int kilometersPerOurToBeufortScale(double windSpeed) {
        int windB = (int) Math.pow(windSpeed / BEAUFORT_CONSTANT, 1.5);
        /*if (windB > 12) {
            windB = 12;
        }
        return windB;*/
        return Math.min(windB, 12);
    }
    ...
    private static String getWindStrength(int windSpeed) {
        ...
        return windSpeed; */
        return windSpeed <= 20 ? "ramus" : "striprus";
    }
}